...
export function BottomSheet({ open, onClose, children }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end"
      ...
      <div className="relative w-full bg-white rounded-t-2xl p-4 pb-8 max-h-[85vh] overflow-y-auto"
        style={{ overscrollBehavior: 'contain', WebkitOverflowScrolling: 'touch' as const }}>
